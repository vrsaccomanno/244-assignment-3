...
- Final sentence for publication: These data suggest that there is not a significant difference in weight between male and female lizards in the Northern Chihuahuan Desert (U =2255.5, p =0.5844)
...
#X-squared = 0.30857, df = 1, p-value = 0.5786
```

####Task 4, question two conclusion:
- There is not a significant association between lizard sex and broken tails (X2(1)=0.308, p=0.5786)